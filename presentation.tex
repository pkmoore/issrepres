...
\begin{frame}{How do Environments Affect ?}
  \begin{itemize}
...
\begin{frame}{SEA on the Half-Shell}
  ...
  \item{Analyze the recording to identify
      to determine how the failure is present in the application's system
          calls}
  \item{Simulate this failure on another application and assess how it
      responds}
  \end{enumerate}
\end{frame}
...
\begin{frame}{Generic Example}
  \begin{enumerate}
  \item{Generic example goes here}
  \end{enumerate}
\end{frame}
