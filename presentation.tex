...
\begin{frame}{How Does an Environment Influence an Application?}
  \begin{itemize}
    % an environment is anything out of the developer's control
...
\begin{frame}{Environments Differ on Many Levels}
  \begin{itemize}
    ...
    % Maybe use reliability or dependability instead of condition here
...
\begin{frame}{Environmental Variations Can Reveal Bugs!}
  ...
  % Identifying these bugs is hard because there are two many variations to
  % test against
...
\begin{frame}{What is needed...}
  % Put some kind of visual element in here to take up some of the white
  % space
  \begin{itemize}
...
\begin{frame}{Simulating Environmental Anomalies (SEA)}
  % Point that says what SEA does.  Almost something like the content in
  % the title
  \begin{itemize}
...
\begin{frame}{Generic Example}
  % This may be too esoteric for a presentation
  \begin{enumerate}
...
\begin{frame}{Identifying and Encoding Anomalies}
  % Subheading to show this is steps in the process
  \begin{itemize}
...
\begin{frame}{Architecture Discussion}
  % Maybe multiple slices of the above image with each of these points
  % below to illustrate which part does what
  \begin{itemize}
...
\begin{frame}{Anomalies Used}
  % Change the title of this slide so it transitions better
  \begin{itemize}
...
\begin{frame}{Aspell Bug Discussion}
  ...
  % Maybe put mini-case study in the subheading
  \begin{itemize}
...
\begin{frame}{Unusual Filetypes - The Takeaway}
  ...
  % Learned that applications fail to check file types before operating on
  % them
  % % This means that.... developers need to pay more attention to
...
\begin{frame}{Cross-Disk File Movement - The Takeaway}
  ...
  \begin{itemize}
    \item{Well known, popular applications are not moving files correctly}
      % Take the point a little further like in the above takeaway slide
  \end{itemize}
\end{frame}
...
\begin{frame}{Extremely Long Network Timeouts - The Takeaway}
  ...
  \begin{itemize}
    ...
    % Include "what are we supposed to do about it"
  \end{itemize}
\end{frame}
...
\begin{frame}{In Conclusion}
  \begin{itemize}
    ...
    \item{SEA helps find these bugs by simulating problematic environmental
      features in order to identify bugs before deployment, thereby
